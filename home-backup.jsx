            ...
            <Box sx={{
                ...
                <Box sx={{ // shopping block and table block
                    ...
                    <Box // add item button and a money display
                        ...
                        <Button variant="contained" onClick={handleAddItems} color="secondary" >Add Items + </Button>
                        <Button variant="contained" onClick={handleAddBalance} color="secondary" >Add Balance + </Button>
